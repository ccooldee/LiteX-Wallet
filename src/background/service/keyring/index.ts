...
import { AddressType, WalletHistory } from '@/shared/types';
...
class KeyringService extends EventEmitter {
  ...
  transactionHistorys: WalletHistory[];
  ...
  addWalletHistory = (history: WalletHistory) => {
    this.transactionHistorys.unshift(history);
  }

  getWalletHistory = () => {
    return this.transactionHistorys;
  }
