...
import { AddressType, BitcoinBalance, NetworkType, ToSignInput, UTXO, WalletKeyring, Account, WalletHistory } from '@/shared/types';
...
export class WalletController extends BaseController {
  ...
  addWalletHistory = (history: WalletHistory) => {
    keyringService.addWalletHistory(history);
  }

  getWalletHistory = () => {
    return keyringService.getWalletHistory();
  }
