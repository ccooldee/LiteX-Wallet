      ...
      <Content preset="middle">
        <div className="flex flex-col realtive w-[100%] bg-[#0c0c0c]">
          <div className="bg-[#1a1a1a] flex flex-row gap-2 items-center justify-center p-4">
            <div className="text-[24px] text-white mt-4">Switch Network</div>
          </div>
          <div className="flex flex-col gap-4 justify-center items-center pt-[32px] w-[100%]">
            <WebsiteBar session={session} />
            <div className="w-[100%] px-4 py-[32px]">
              <Row justifyBetween itemsCenter mt="lg">
                <Card preset="style2" px="lg">
                  <Text text={from.label} preset="title-bold" color="white"/>
                </Card>
                <Text text=">" color="white"/>
                <Card preset="style2" px="lg">
                  <Text text={to.label} preset="title-bold" color="white"/>
                </Card>
              </Row>
            </div>
          </div>
