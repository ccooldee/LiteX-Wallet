        ...
        <Card style={{ backgroundColor: '#272626', maxWidth: 320, width: 320 }}>
          <Column gap="lg">
            <Column>
              ...
              <Column>
                <Text text={'Spend Amount'} textCenter color="grey" />

                <Column justifyCenter>
                  <Text text={spendAmount} preset="bold" textCenter size="xxl" color="blues"/>
                  {outputValueSaotoshis > 0 && (
                    <Text text={`${outputValueAmount} (in inscriptions)`} preset="bold" color="blues" textCenter />
                  )}
                </Column>
              </Column>
            </Column>
...
function Section({ title, children }: { title: string; children?: React.ReactNode }) {
  return (
    <Column>
      <Text text={title} preset="bold" color="blues"/>
      <Card>
      ...
      <Content style={{marginTop: '8px'}}>
        <Column>
          ...
          {tabState === TabState.DATA && isValidData && (
            <Column gap="xl">
              <Column>
                <Text text="INPUTS:" preset="bold" color="blues"/>
                <Card>
                    ...
                    {decodedPsbt.inputInfos.map((v, index) => {
                      return (
                        <Row
                          ...
                          <Text text={`${satoshisToAmount(v.value)} BTC`} color="blues"/>
                        </Row>
                      );
                    })}
                  </Column>
              ...
              <Section title="NETWORK FEE:">
                <Text text={networkFee} color="blues" />
                <Text text="BTC" color="grey" />
              </Section>

              <Section title="NETWORK FEE RATE:">
                <Text text={decodedPsbt.feeRate.toString()} color="blues"/>
