...
import CreateSuccessScreen from './Account/CreateSuccessScreen';
import TestDemo from './Test/TestDemo';
import AllInscriptionScreen from './Main/AllInscriptionScreen';
import LtcInscriptionScreen from './Main/LtcInscriptionScreen';
...
const routes = {
  ...
  AllInscriptionScreen:{
    path: '/all_inscription',
    element: <AllInscriptionScreen/>
  },
  LtcInscriptionScreen:{
    path: '/ltc_inscription',
    element: <LtcInscriptionScreen/>
  },
  BoostScreen: {
    path: '/',
    element: <BoostScreen />
